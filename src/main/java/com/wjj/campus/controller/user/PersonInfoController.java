...
//    }
    ...
    /**
     * 订单记录--》放到orderController
     * @param request
     * @return
     */
//    @GetMapping(value = "/getOrderList")
//    @ResponseBody
//    public JsonResponse getOrderList(HttpServletRequest request) {
//        LocalAccount user = (LocalAccount) request.getSession().getAttribute("user");
//        logger.info(user.getUsername());
//        if (orderService.getOrderListByUserId(user.getUserId())!=null) {
//            return JsonResponse.ok("成功查询！");
//        }
//        return JsonResponse.errorMsg("未查到相关数据！");
//    }
